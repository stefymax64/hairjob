 ...
 */
final class Version20200617151444 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert_user (advert_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_C4B39704A76ED395 (user_id), INDEX IDX_C4B39704D07ECCB6 (advert_id), PRIMARY KEY(advert_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
