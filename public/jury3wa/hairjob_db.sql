...
--
-- Hôte : localhost
-- Généré le :  Dim 28 juin 2020 à 15:53
...
(17, 17, '2020-06-27 09:54:00', 'Recherche Barbier H/F', '<p>essai</p>', 1, '2020-06-27 09:55:05', 0, 'recherche-barbier-h-f-1', 'Clémentine');
...
(40, 'cstefy@live.fr', '[]', '$argon2id$v=19$m=65536,t=4,p=1$WklTMWp0SFlvd3NyLjVFRA$Wu3ziMTbI3Q2QPuwjkNGgMya0gClMTI5EaZ7FzciHzQ', 'toto', NULL, NULL, NULL, 'test', '0629753804', 'Mauressac'),
(41, 'jury@3wa.fr', '{\"0\":\"ROLE_ADMIN\",\"2\":\"ROLE_RECRUITER\"}', '$argon2id$v=19$m=65536,t=4,p=1$aFBjL003cmo1QTFGb2dHRQ$7ICFgc7jXOgOp5Vi08xG78cV9H0Kkcgm2SlpRfKZh7M', 'Jury', NULL, NULL, 0, '3WA', '0000000000', 'Toulouse');
